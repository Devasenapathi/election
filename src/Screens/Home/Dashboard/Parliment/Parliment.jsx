...
import '../Parliment/parliment.css'
...
const Parliment = () => {
  ...
  const fetchData = () => {
    axios.get("main/getLokshaba").then((v) => {
      setStates(v.data)
    })
  }
  ...
  const handleConstituency = (e) => {
   setConstituency(e)
    ...
    axios.get('/main/getLokshabaData/', { params: value }).then((item) => {
  ...
  const getState = () => {
    return (
      <div >
        <select value={selectedState} onChange={e => handleState(e.target.value)} className='btn btn-primary dropdown-toggle'>
      ...
      <div className='assembly'>
        ...
        <div className='grid p-10 mt-4'>
          <div className='d-flex mb-5'>
            ...
            <div className='g-col-6'>
              {index !== undefined && index !== -1 ? getYear() : ''}
            </div>
          </div>
          <div>
